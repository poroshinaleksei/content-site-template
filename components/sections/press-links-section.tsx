...
import type { PressLinksSection as PressLinksSectionConfig } from "@/config/types";

import { SectionShell } from "./section-shell";

type PressLinksSectionProps = {
  section: PressLinksSectionConfig;
};

export function PressLinksSection({ section }: PressLinksSectionProps) {
  return (
    <SectionShell>
      <div className="grid gap-8 md:grid-cols-[0.85fr_1.15fr]">
        ...
        <div className="grid gap-3">
          {section.links.map((link) => (
            ...
            >
              <ArrowUpRight aria-hidden="true" className="mt-1 size-5 text-primary" />
              <span>
